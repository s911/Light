...
<section class="hero">
    <div class="container">
        ...
        <div class="cta-row">
            <a class="btn btn-gradient" href="<?php echo esc_url(home_url('/products')); ?>">Shop Products</a>
            <a class="btn btn-outline" href="<?php echo esc_url(home_url('/for-business')); ?>">Request Bulk Quote</a>
        </div>
    </div>
</section>
